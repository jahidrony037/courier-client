...
const CustomerDashboard = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      to: "profile",
      icon: "👤",
      isActive: location.pathname.includes("/customer/dashboard/profile"),
    },
    {
      name: "Book Parcel",
      to: "book-parcel",
      icon: "📦",
      isActive: location.pathname.includes("/customer/dashboard/book-parcel"),
    },
    {
    ...
    },
    {
      ...
      to: "track-parcel",
      icon: "🔍",
      isActive: location.pathname.includes("/customer/dashboard/track-parcel"),
    },
  ];
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Manage your parcels</p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 ml-72">
        {/* Content Header */}
        <div className="bg-white shadow-sm border-b border-gray-200 p-6 mt-1">
